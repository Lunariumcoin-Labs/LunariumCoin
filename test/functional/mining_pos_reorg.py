...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected XLN supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check XLN supply at the beginning
        # ------------------------------------------
        # XLN supply: block rewards minus burned fees for minting
        ...
        # Verify that XLN supplies were properly updated after the spends and reorgs
        self.log.info("Check XLN supply...")
