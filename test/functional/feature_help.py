...
"""Verify that starting lunariumcoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lunariumcoin with -? for help text")
        ...
        self.log.info("Start lunariumcoin with -version for version information")
