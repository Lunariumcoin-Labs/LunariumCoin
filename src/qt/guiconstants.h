...
/* LunariumCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LunariumCoin"
#define QAPP_ORG_DOMAIN "lunariumcoin.org"
#define QAPP_APP_NAME_DEFAULT "LunariumCoin-Qt"
#define QAPP_APP_NAME_TESTNET "LunariumCoin-Qt-testnet"
