...
/** Utility functions used by the LunariumCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render XLN addresses in monospace font
...
// Parse "lunariumcoin:" URI into recipient object, return true on successful parsing
