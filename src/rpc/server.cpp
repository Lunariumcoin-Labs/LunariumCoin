...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop LunariumCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "LunariumCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XLN features */
        {"lunariumcoin", "listmasternodes", &listmasternodes, true },
        {"lunariumcoin", "getmasternodecount", &getmasternodecount, true },
        {"lunariumcoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"lunariumcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"lunariumcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"lunariumcoin", "masternodecurrent", &masternodecurrent, true },
        {"lunariumcoin", "startmasternode", &startmasternode, true },
        {"lunariumcoin", "reloadmasternodeconfig", &reloadmasternodeconfig, true },
        {"lunariumcoin", "createmasternodekey", &createmasternodekey, true },
        {"lunariumcoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"lunariumcoin", "listmasternodeconf", &listmasternodeconf, true },
        {"lunariumcoin", "getactivemasternodecount", &getactivemasternodecount, true },
        {"lunariumcoin", "getmasternodestatus", &getmasternodestatus, true },
        {"lunariumcoin", "getmasternodewinners", &getmasternodewinners, true },
        {"lunariumcoin", "getmasternodescores", &getmasternodescores, true },
        {"lunariumcoin", "mnsync", &mnsync, true },
        {"lunariumcoin", "spork", &spork, true },
        {"lunariumcoin", "mnping", &mnping, true },
...
{
    return "> lunariumcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13980/\n";
}
