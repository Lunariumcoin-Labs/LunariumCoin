...
UniValue getnewv2address(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            "getnewv2address ( \"label\" )\n"
            "\nSame as getnewaddress but encodes with the configured V2 P2PKH prefix (e.g. L on mainnet).\n"
            "\nArguments:\n"
            "1. \"label\"        (string, optional) Address book label.\n"
            "\nResult:\n"
            "\"address\"        (string) Receive address using V2 Base58 prefix\n");

    return EncodeDestinationForceAddressV2(GetNewAddressFromLabel(AddressBook::AddressBookPurpose::RECEIVE, request.params));
}
...
{       //  category              name                        actor (function)           okSafeMode
        ...
        { "hidden",             "getnewv2address",          &getnewv2address,          true  },
