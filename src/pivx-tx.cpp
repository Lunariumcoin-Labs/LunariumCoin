...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LunariumCoin lunariumcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lunariumcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lunariumcoin transaction") + "\n" +
                               "  lunariumcoin-tx [options] -create [commands]   " + _("Create hex-encoded lunariumcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lunariumcoin transaction
