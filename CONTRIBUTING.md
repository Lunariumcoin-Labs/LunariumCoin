Contributing to LunariumCoin Core
============================

The LunariumCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LunariumCoin Core project, and is not to be
confused with overall LunariumCoin Network Protocol consensus changes.

Whether a pull request is merged into LunariumCoin Core rests with the project merge
...
Patches that change LunariumCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the LunariumCoin consensus, it must have been
...
The project leader is the release manager for each LunariumCoin Core release.
