...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='lunariumcoin.conf'
CONFIGFOLDER='/root/.lunariumcoin'
COIN_DAEMON='lunariumcoind'
COIN_CLI='lunariumcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/lunariumCoin/XLN/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='lunariumcoin'
COIN_PORT=13990
RPC_PORT=13980
