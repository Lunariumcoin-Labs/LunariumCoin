...
$(package)_patches=fix_gcc_11_3_compile.patch fix_darwin_clang_fcoalesce_templates.patch fix_darwin_macosx_version_min.patch
...
define $(package)_preprocess_cmds
  ...
  patch -p1 -i $($(package)_patch_dir)/fix_darwin_clang_fcoalesce_templates.patch && \
  patch -p1 -i $($(package)_patch_dir)/fix_darwin_macosx_version_min.patch
endef
